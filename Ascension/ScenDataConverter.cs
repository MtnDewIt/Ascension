...
namespace Ascension
{
    ...
    public class NetEquip : ObjectPlacement
    {
        public long SpawnTime { get; set; }
        public string CollectionType { get; set; }
    }

    public class SpWeapLoc : ObjectPlacement
    {
        public int RoundsLeft { get; set; }
        public int RoundsLoaded { get; set; }
    }

    public class Scenery : ObjectPlacement
    {
        public int PathfindingType { get; set; }
        public int LightmappingType { get; set; }
    }

    public class TrigVol
    {
    ...
    public class Vehicle : ObjectPlacement
    {
        public float BodyVitality { get; set; }
    }

    public class Device : ObjectPlacement
    {
    ...
    public class Biped : ObjectPlacement
    {
        public float BodyVitality { get; set; }
        public uint BipedFlags { get; set; }
    }

    public class SoundScenery : ObjectPlacement
    {
    ...
    public class Crate : ObjectPlacement { }
